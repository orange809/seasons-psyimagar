...
public class JudutiechuiItem extends SeasonsPsyimagarModElements.ModElement{

	@ObjectHolder("seasons_psyimagar:judutiechui")
	public static final Item block = null;

	public JudutiechuiItem (SeasonsPsyimagarModElements instance) {
		super(instance, 251);
	}
	...
	@Override public void initElements() {
        ...
        JudutiechuiDangYouJianDianJiKongQiShiProcedure.executeProcedure(Stream.of(
...
;
        ...
        JudutiechuiDangShiTiBeiGongJuJiZhongShiProcedure.executeProcedure(Stream.of(
