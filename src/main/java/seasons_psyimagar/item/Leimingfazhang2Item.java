...
public class Leimingfazhang2Item extends SeasonsPsyimagarModElements.ModElement{

	@ObjectHolder("seasons_psyimagar:leimingfazhang_2")
	public static final Item block = null;

	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_leimingfazhang_2").setRegistryName("projectile_leimingfazhang_2");

	public Leimingfazhang2Item(SeasonsPsyimagarModElements instance) {
		super(instance, 259);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
        ...
        LeiingfazhangDangZiDanJiZhongShengCunShiTiShiProcedure.executeProcedure(Stream.of(
...
;
        ...
        LeiingfazhangDangZiDanJiZhongFangKuaiShiProcedure.executeProcedure(Stream.of(
        new AbstractMap.SimpleEntry<>("world", world),new AbstractMap.SimpleEntry<>("x", x),new AbstractMap.SimpleEntry<>("y", y),new AbstractMap.SimpleEntry<>("z", z)
        ).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))
;
		}
