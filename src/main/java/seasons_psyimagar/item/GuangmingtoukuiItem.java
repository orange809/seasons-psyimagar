...
@SeasonsPsyimagarModElements.ModElement.Tag public class GuangmingtoukuiItem extends SeasonsPsyimagarModElements.ModElement{

	@ObjectHolder("seasons_psyimagar:guangmingtoukui_helmet")
	public static final Item helmet = null;

	@ObjectHolder("seasons_psyimagar:guangmingtoukui_chestplate")
	public static final Item body = null;

	@ObjectHolder("seasons_psyimagar:guangmingtoukui_leggings")
	public static final Item legs = null;

	@ObjectHolder("seasons_psyimagar:guangmingtoukui_boots")
	public static final Item boots = null;

	public GuangmingtoukuiItem (SeasonsPsyimagarModElements instance) {
		super(instance, 229);
	}
	...
	@Override public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			@Override public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(
							new ItemStack(GuangyuansuItem.block)
						);
			}
        ...
        elements.items.add(() ->
			new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(SeasonsPsyimagarItemGroup.tab)) {
				...
				@Override public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
					return "seasons_psyimagar:textures/models/armor/guang_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
				}
        ...
        GuangmingjiaProcedure.executeProcedure(Stream.of(
