...
public class QiuzhimubanBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:qiuzhimuban")
	public static final Block block = null;


	public QiuzhimubanBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 84);
