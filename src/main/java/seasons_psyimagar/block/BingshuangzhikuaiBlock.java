...
public class BingshuangzhikuaiBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:bingshuangzhikuai")
	public static final Block block = null;


	public BingshuangzhikuaiBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 107);
