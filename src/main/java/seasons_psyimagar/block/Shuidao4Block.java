...
public class Shuidao4Block extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:shuidao_4")
	public static final Block block = null;


	public Shuidao4Block (SeasonsPsyimagarModElements instance) {
		super(instance, 638);
	...
	public static class CustomBlock extends
        ...
        Shuidao4GengXinYouXiKeProcedure.executeProcedure(Stream.of(
...
;
        ...
        Shuidao4ZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream.of(
