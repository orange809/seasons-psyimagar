...
public class MtouBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:mtou")
	public static final Block block = null;


	public MtouBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 57);
