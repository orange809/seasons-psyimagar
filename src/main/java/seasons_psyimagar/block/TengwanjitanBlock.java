...
public class TengwanjitanBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:tengwanjitan")
	public static final Block block = null;

	@ObjectHolder("seasons_psyimagar:tengwanjitan")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public TengwanjitanBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 8);
