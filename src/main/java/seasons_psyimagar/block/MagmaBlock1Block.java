...
public class MagmaBlock1Block extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:magma_block_1")
	public static final Block block = null;

	@ObjectHolder("seasons_psyimagar:magma_block_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public MagmaBlock1Block (SeasonsPsyimagarModElements instance) {
		super(instance, 663);
...
;
        ...
        MagmaBlock1UpdateTickProcedure.executeProcedure(Stream.of(
        new AbstractMap.SimpleEntry<>("world", world),new AbstractMap.SimpleEntry<>("x", x),new AbstractMap.SimpleEntry<>("y", y),new AbstractMap.SimpleEntry<>("z", z)
        ).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))
;
