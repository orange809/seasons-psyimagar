...
public class HuijinguoshiBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:huijinguoshi")
	public static final Block block = null;


	public HuijinguoshiBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 103);
				...
				Block
 {
        ...
        HuijinguoshiDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
