...
public class XiazhidifangkuaiBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:xiazhidifangkuai")
	public static final Block block = null;


	public XiazhidifangkuaiBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 23);
				...
				FallingBlock
 {
		...
		public CustomBlock() {
			...
			Block.Properties.create(Material.SAND)
				...
				.hardnessAndResistance(0.75f, 5f)
				.setLightLevel(s -> 0)
			);
        ...
        XiazhidifangkuaiDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
