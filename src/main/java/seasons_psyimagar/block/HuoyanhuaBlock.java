...
public class HuoyanhuaBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:huoyanhua")
	public static final Block block = null;


	public HuoyanhuaBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 125);
    ...
    return 
    VoxelShapes.or(
                makeCuboidShape(3, 0, 3, 16, 11, 16)
    ...
    .withOffset(offset.x, offset.y, offset.z);
        ...
        HuoyanhuaGengXinYouXiKeProcedure.executeProcedure(Stream.of(
...
if(        true
	...
	for (int l = 0; l < 8; ++l) {
        ...
        HuoyanuaDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
