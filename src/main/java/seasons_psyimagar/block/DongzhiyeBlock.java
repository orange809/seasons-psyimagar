...
public class DongzhiyeBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:dongzhiye")
	public static final Block block = null;


	public DongzhiyeBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 138);
	...
	public static class CustomBlock extends
        ...
        DongzhiyehtmlDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
