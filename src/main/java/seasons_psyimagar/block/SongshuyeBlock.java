...
public class SongshuyeBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:songshuye")
	public static final Block block = null;


	public SongshuyeBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 134);
	...
	public static class CustomBlock extends
        ...
        SongshuyeDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
