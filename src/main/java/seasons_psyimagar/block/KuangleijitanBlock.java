...
public class KuangleijitanBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:kuangleijitan")
	public static final Block block = null;

	@ObjectHolder("seasons_psyimagar:kuangleijitan")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public KuangleijitanBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 10);
