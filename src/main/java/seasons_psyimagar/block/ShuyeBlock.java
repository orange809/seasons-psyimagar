...
public class ShuyeBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:shuye")
	public static final Block block = null;


	public ShuyeBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 133);
	...
	public static class CustomBlock extends
        ...
        ShuyehtmlDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
