...
public class Shuidao3Block extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:shuidao_3")
	public static final Block block = null;


	public Shuidao3Block (SeasonsPsyimagarModElements instance) {
		super(instance, 637);
	...
	public static class CustomBlock extends
        ...
        Shuidao3GengXinYouXiKeProcedure.executeProcedure(Stream.of(
...
;
        ...
        Shuidao3ZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream.of(
