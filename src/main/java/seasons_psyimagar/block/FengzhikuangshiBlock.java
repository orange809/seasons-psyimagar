...
public class FengzhikuangshiBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:fengzhikuangshi")
	public static final Block block = null;


	public FengzhikuangshiBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 43);
	...
	public static class CustomBlock extends
        ...
        FengzhikuangshiDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
