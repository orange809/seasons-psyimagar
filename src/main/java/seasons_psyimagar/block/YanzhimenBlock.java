...
public class YanzhimenBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:yanzhimen")
	public static final Block block = null;


	public YanzhimenBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 80);
