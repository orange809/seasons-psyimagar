...
public class Shuidao5Block extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:shuidao_5")
	public static final Block block = null;


	public Shuidao5Block (SeasonsPsyimagarModElements instance) {
		super(instance, 639);
	...
	public static class CustomBlock extends
        ...
        Shuidao5GengXinYouXiKeProcedure.executeProcedure(Stream.of(
...
;
        ...
        Shuidao5ZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream.of(
