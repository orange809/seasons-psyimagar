...
public class BingshuangkuangshiBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:bingshuangkuangshi")
	public static final Block block = null;


	public BingshuangkuangshiBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 46);
...
if(        true
	...
	private static class FeatureRegisterHandler {
		...
		@SubscribeEvent public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("seasons_psyimagar:bingshuangkuangshi_match"), () -> CustomRuleTest.codec);
        ...
        BingshuangkuangshiFuJiaDeShengChengTiaoJianProcedure.executeProcedure(Stream.of(
        new AbstractMap.SimpleEntry<>("y", y)
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("seasons_psyimagar:bingshuangkuangshi"), configuredFeature);
		}
