...
public class YanzhihuobanmenBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:yanzhihuobanmen")
	public static final Block block = null;


	public YanzhihuobanmenBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 81);
