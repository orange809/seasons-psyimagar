...
public class SBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:s")
	public static final Block block = null;


	public SBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 335);
    ...
    return 
    VoxelShapes.or(
                makeCuboidShape(4, 5, 4, 12, 16, 12)
    ...
    .withOffset(offset.x, offset.y, offset.z);
        ...
        SGengXinYouXiKeProcedure.executeProcedure(Stream.of(
...
;
        ...
        SDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
        new AbstractMap.SimpleEntry<>("world", world),new AbstractMap.SimpleEntry<>("x", x),new AbstractMap.SimpleEntry<>("y", y),new AbstractMap.SimpleEntry<>("z", z)
        ).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))
;
			return retval;
        ...
        SZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream.of(
        new AbstractMap.SimpleEntry<>("world", world),new AbstractMap.SimpleEntry<>("x", x),new AbstractMap.SimpleEntry<>("y", y),new AbstractMap.SimpleEntry<>("z", z)
        ).collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))
;
