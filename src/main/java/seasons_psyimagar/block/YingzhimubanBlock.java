...
public class YingzhimubanBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:yingzhimuban")
	public static final Block block = null;


	public YingzhimubanBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 66);
