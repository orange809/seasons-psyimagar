...
public class Shuidao6Block extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:shuidao_6")
	public static final Block block = null;


	public Shuidao6Block (SeasonsPsyimagarModElements instance) {
		super(instance, 640);
	...
	public static class CustomBlock extends
        ...
        Shuidao6GengXinYouXiKeProcedure.executeProcedure(Stream.of(
...
;
        ...
        Shuidao6ZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream.of(
