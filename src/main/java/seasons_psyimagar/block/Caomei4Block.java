...
@SeasonsPsyimagarModElements.ModElement.Tag public class Caomei4Block extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:caomei_4")
	public static final Block block = null;


	public Caomei4Block(SeasonsPsyimagarModElements instance) {
		super(instance, 591);
	...
	private static class FeatureRegisterHandler {
		...
		@SubscribeEvent public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("seasons_psyimagar:caomei_4"), configuredFeature);
		}
...
;
        ...
        Caomei3DangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
...
;
        ...
        Caomei3ZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream.of(
