...
public class CubingshuangkuaiBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:cubingshuangkuai")
	public static final Block block = null;


	public CubingshuangkuaiBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 47);
...
if(        true
	...
	private static class FeatureRegisterHandler {
		...
		@SubscribeEvent public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("seasons_psyimagar:cubingshuangkuai_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("seasons_psyimagar:cubingshuangkuai"), configuredFeature);
		}
