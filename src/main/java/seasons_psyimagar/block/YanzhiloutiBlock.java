...
public class YanzhiloutiBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:yanzhilouti")
	public static final Block block = null;


	public YanzhiloutiBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 76);
