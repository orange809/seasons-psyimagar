...
public class NituBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:nitu")
	public static final Block block = null;


	public NituBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 20);
				...
				Block
 {
        ...
        CaofangkuaiDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
