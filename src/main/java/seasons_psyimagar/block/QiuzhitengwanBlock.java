...
public class QiuzhitengwanBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:qiuzhitengwan")
	public static final Block block = null;


	public QiuzhitengwanBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 127);
	...
	public static class CustomBlock extends
        ...
        QiuzhitengwanFangZhiFangKuaiShiProcedure.executeProcedure(Stream.of(
...
;
        ...
        QiuzhitengwanDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
