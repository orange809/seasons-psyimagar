...
public class QiuzhishumuBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:qiuzhishumu")
	public static final Block block = null;


	public QiuzhishumuBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 33);
