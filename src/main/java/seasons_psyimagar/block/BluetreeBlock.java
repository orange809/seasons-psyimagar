...
public class BluetreeBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:bluetree")
	public static final Block block = null;


	public BluetreeBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 34);
