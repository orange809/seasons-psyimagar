...
public class YunduofangkuaiBlock extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:yunduofangkuai")
	public static final Block block = null;


	public YunduofangkuaiBlock (SeasonsPsyimagarModElements instance) {
		super(instance, 143);
				...
				Block
 {
        ...
        YunduofangkuaiDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream.of(
