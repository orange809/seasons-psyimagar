...
public class Shuidao2Block extends SeasonsPsyimagarModElements.ModElement {

	@ObjectHolder("seasons_psyimagar:shuidao_2")
	public static final Block block = null;


	public Shuidao2Block (SeasonsPsyimagarModElements instance) {
		super(instance, 636);
	...
	public static class CustomBlock extends
        ...
        Shuidao2GengXinYouXiKesProcedure.executeProcedure(Stream.of(
...
;
        ...
        Shuidao2ZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream.of(
