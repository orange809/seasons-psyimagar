...
@SeasonsPsyimagarModElements.ModElement.Tag public class VineEntity extends SeasonsPsyimagarModElements.ModElement {
	...
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(128).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
					.size(0.4f, 1.5f))
			.build("vine").setRegistryName("vine");


	public VineEntity(SeasonsPsyimagarModElements instance) {
		super(instance, 308);
	...
	public static class CustomEntity extends MonsterEntity {
        ...
        VineDangShiTiGengXinKeShiProcedure.executeProcedure(Stream.of(
