...
@OnlyIn(Dist.CLIENT) public class LongjuanfengguaiRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(LongjuanfengguaiEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modellongjuanfengguai(), 0.5f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/longjuanfengguai.png"); }
