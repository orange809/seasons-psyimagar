...
@OnlyIn(Dist.CLIENT) public class XiyouqieRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(XiyouqieEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelqie(), 0.5f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/xiyoudeqieyumao.png"); }
