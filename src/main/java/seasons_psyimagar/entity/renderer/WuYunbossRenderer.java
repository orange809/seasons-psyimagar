...
@OnlyIn(Dist.CLIENT) public class WuYunbossRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(WuYunbossEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelwuyunboss(), 1f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/wu_yun_boss.png"); }
