...
@OnlyIn(Dist.CLIENT) public class BingShuangShouHuZheRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(BingShuangShouHuZheEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelbingshuangshouhuzhe(), 1f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/bingshuangshouhuzhe.png"); }
