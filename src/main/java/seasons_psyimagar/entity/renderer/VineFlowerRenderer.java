...
@OnlyIn(Dist.CLIENT) public class VineFlowerRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(VineFlowerEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelflower_vine(), 0.5f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/flower_vine.png"); }
