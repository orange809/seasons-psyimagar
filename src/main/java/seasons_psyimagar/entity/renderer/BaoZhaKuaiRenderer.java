...
@OnlyIn(Dist.CLIENT) public class BaoZhaKuaiRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(BaoZhaKuaiEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelbaozhakuai(), 0.25f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/baozhakuai.png"); }
