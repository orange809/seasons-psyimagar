...
@OnlyIn(Dist.CLIENT) public class VineRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(VineEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelvine(), 0.5f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/vine.png"); }
