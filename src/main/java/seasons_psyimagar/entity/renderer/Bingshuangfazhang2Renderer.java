...
@OnlyIn(Dist.CLIENT) public class Bingshuangfazhang2Renderer {
	...
	@OnlyIn(Dist.CLIENT) public static class CustomRender extends EntityRenderer<Bingshuangfazhang2Item.ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("seasons_psyimagar:textures/bingzidan.png");

		public CustomRender(EntityRendererManager renderManager) {
			super(renderManager);
		}

		@Override public void render(Bingshuangfazhang2Item.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
		...
		@Override public ResourceLocation getEntityTexture(Bingshuangfazhang2Item.ArrowCustomEntity entity) {
			return texture;
		}
	}
