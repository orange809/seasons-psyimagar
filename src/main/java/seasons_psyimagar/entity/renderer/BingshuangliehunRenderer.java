...
@OnlyIn(Dist.CLIENT) public class BingshuangliehunRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(BingshuangliehunEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelbingshuangliehun(), 0.5f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/bingshuangliehun.png"); }
