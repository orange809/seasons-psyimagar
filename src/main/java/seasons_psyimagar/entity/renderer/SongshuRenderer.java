...
@OnlyIn(Dist.CLIENT) public class SongshuRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(SongshuEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelsongshu(), 0.3f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/songshu.png"); }
