...
@OnlyIn(Dist.CLIENT) public class FlowerSpiritRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(FlowerSpiritEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelflower_spirit(), 0.5f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/flower_spirit.png"); }
