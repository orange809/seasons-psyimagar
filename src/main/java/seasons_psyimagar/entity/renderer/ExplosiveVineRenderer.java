...
@OnlyIn(Dist.CLIENT) public class ExplosiveVineRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(ExplosiveVineEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelbaozhatengwan(), 0.25f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/v1oupkf70ctusdl9i.png"); }
