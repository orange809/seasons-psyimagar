...
@OnlyIn(Dist.CLIENT) public class Yunguoguai3Renderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(Yunguoguai3Entity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelyunguoguai3(), 0.5f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/yunguoguai1.2.3.png"); }
