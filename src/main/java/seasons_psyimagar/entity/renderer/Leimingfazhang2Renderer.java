...
@OnlyIn(Dist.CLIENT) public class Leimingfazhang2Renderer {
	...
	@OnlyIn(Dist.CLIENT) public static class CustomRender extends EntityRenderer<Leimingfazhang2Item.ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("seasons_psyimagar:textures/leizidan.png");

		public CustomRender(EntityRendererManager renderManager) {
			super(renderManager);
		}

		@Override public void render(Leimingfazhang2Item.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
		...
		@Override public ResourceLocation getEntityTexture(Leimingfazhang2Item.ArrowCustomEntity entity) {
			return texture;
		}
	}
