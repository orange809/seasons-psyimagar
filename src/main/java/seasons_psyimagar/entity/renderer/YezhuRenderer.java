...
@OnlyIn(Dist.CLIENT) public class YezhuRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(YezhuEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelyezhu(), 0.5f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/yezhu.png"); }
