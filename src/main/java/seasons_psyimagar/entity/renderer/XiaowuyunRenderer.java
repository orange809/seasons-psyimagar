...
@OnlyIn(Dist.CLIENT) public class XiaowuyunRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(XiaowuyunEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelxiaowuyun(), 0.5f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("seasons_psyimagar:textures/xiaowuyun.png"); }
