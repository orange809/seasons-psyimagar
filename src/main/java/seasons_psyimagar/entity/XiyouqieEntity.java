...
@SeasonsPsyimagarModElements.ModElement.Tag public class XiyouqieEntity extends SeasonsPsyimagarModElements.ModElement {

	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
					.size(0.8f, 1.6f))
			.build("xiyouqie").setRegistryName("xiyouqie");


	public XiyouqieEntity(SeasonsPsyimagarModElements instance) {
		super(instance, 299);
	...
	@Override public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6724096, -6710887,
	...
	public static class CustomEntity extends CreatureEntity {
        ...
        XiyouqieShiTiSiWangShiProcedure.executeProcedure(Stream.of(
