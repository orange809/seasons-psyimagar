...
@SeasonsPsyimagarModElements.ModElement.Tag public class Yunguoguai2Entity extends SeasonsPsyimagarModElements.ModElement {
	...
	public Yunguoguai2Entity(SeasonsPsyimagarModElements instance) {
		super(instance, 309);
...
;
        ...
        Yunguoguai2DangShiTiGengXinKeShiProcedure.executeProcedure(Stream.of(
