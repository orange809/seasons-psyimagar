...
@SeasonsPsyimagarModElements.ModElement.Tag public class HongsmoguguaiEntity extends SeasonsPsyimagarModElements.ModElement {

	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
					.size(0.9f, 0.8f))
			.build("hongsmoguguai").setRegistryName("hongsmoguguai");


	public HongsmoguguaiEntity(SeasonsPsyimagarModElements instance) {
		super(instance, 306);
	...
	public static class CustomEntity extends CreatureEntity {
        ...
        HongsmoguguaiShiTiSiWangShiProcedure.executeProcedure(Stream.of(
...
;
        ...
        HongsmoguguaiDangYouJianDianJiShiTiProcedure.executeProcedure(Stream.of(
