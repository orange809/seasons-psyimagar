...
@SeasonsPsyimagarModElements.ModElement.Tag public class JijingEntity extends SeasonsPsyimagarModElements.ModElement {
	...
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(128).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
					.size(1.1f, 2.3f))
			.build("jijing").setRegistryName("jijing");


	public JijingEntity(SeasonsPsyimagarModElements instance) {
		super(instance, 304);
...
.setCallsForHelp());this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1, true) {
	...
	@Override protected double getAttackReachSqr(LivingEntity entity) {
        ...
        JijingShiTiSiWangShiProcedure.executeProcedure(Stream.of(
